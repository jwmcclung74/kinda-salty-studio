...
export function Footer() {
  ...
  return (
    <footer className="border-t border-salt-200 bg-salt-900 text-salt-300">
      <div className="container-site py-16">
        <div className="grid gap-12 md:grid-cols-2 lg:grid-cols-4">
          ...
          <div className="lg:col-span-1">
            <Link href="/" className="inline-block">
              ...
              <span className="ml-1.5 text-[10px] font-semibold uppercase tracking-[0.2em] text-salt-500">Studio</span>
            </Link>
          ...
          {/* Quick Links */}
          <div>
            <h3 className="text-xs font-semibold uppercase tracking-widest text-salt-500 mb-4">Navigate</h3>
          ...
          {/* More Links */}
          <div>
            <h3 className="text-xs font-semibold uppercase tracking-widest text-salt-500 mb-4">Info</h3>
            <ul className="space-y-2">
              <li>
            ...
            <div className="mt-6 flex gap-3">
              {siteConfig.social.instagram && (
                <a href={siteConfig.social.instagram} target="_blank" rel="noopener noreferrer" aria-label="Instagram" className="text-salt-500 hover:text-white transition-colors">
          ...
          {/* Newsletter */}
          <div>
            <h3 className="text-xs font-semibold uppercase tracking-widest text-salt-500 mb-4">Stay Updated</h3>
        ...
        <div className="mt-12 border-t border-salt-800 pt-6 flex flex-col sm:flex-row items-center justify-between gap-4">
          <p className="text-xs text-salt-600">© {year} Kinda Salty Studio. All rights reserved.</p>
